...
if (is_dir(realpath('../tests/data/')) && file_exists('../tests/data/test.db')) {
	$testData = realpath('../tests/') . '/data/test.db';
	if (!file_exists($testData)) touch($testData);
	define('DB_URI', "sqlite:///{$testData}");
}
/**
 ...
 */
$kohana_application = '../libs/application';
...
// ----------------------------------------------------------------------------
// $Id: index.php 1178 2009-04-22 11:49:56Z schalme $
//
