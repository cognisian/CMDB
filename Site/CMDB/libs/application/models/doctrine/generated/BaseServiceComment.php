 ...
 */
abstract class BaseServiceComment extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('ServiceComment');
        ...
        $this->hasColumn('service_prop_id', 'integer', 4, array('type' => 'integer', 'unsigned' => '1', 'length' => '4'));
    }

    public function setUp()
    {
        $this->hasOne('ServiceProperty', array('local' => 'service_prop_id',
                                               'foreign' => 'id'));
