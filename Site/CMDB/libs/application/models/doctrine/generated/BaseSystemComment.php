 ...
 */
abstract class BaseSystemComment extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('SystemComment');
        ...
        $this->hasColumn('system_prop_id', 'integer', 4, array('type' => 'integer', 'unsigned' => '1', 'length' => '4'));
    }

    public function setUp()
    {
        $this->hasOne('SystemProperty', array('local' => 'system_prop_id',
                                              'foreign' => 'id'));
