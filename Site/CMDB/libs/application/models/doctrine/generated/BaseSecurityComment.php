 ...
 */
abstract class BaseSecurityComment extends Doctrine_Record
{
    public function setTableDefinition()
    {
        $this->setTableName('SecurityComment');
        ...
        $this->hasColumn('security_prop_id', 'integer', 4, array('type' => 'integer', 'unsigned' => '1', 'primary' => true, 'length' => '4'));
    }

    public function setUp()
    {
        $this->hasOne('SecurityProperty', array('local' => 'security_prop_id',
                                                'foreign' => 'id'));
